...
/**
 * @TableName hangyechengzhen
 */
@TableName(value = "hangyechengzhen")
@Data
public class Hangyechengzhen implements Serializable {
    /**
     *
     */
    ...
    public boolean equals(Object that) {
        ...
        Hangyechengzhen other = (Hangyechengzhen) that;
